...
import { AccountSessionRefreshModule } from './modules/account-session-refresh/account-session-refresh.module';
 ...
 *
 * 该服务不承接业务查询 HTTP 流量, 只消费 RosettaX 主服务写入 Redis Stream 的
